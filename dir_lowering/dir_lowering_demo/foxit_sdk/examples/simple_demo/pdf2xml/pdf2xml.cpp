...
{
  WString output_directory = output_path + L"pdf2xml/";
#if defined(_WIN32) || defined(_WIN64)
  ...
  int err_ret = 0;
  WString src_pdf_path = input_path + L"AboutFoxit.pdf";
  ...
  try {
    WString saved_xml_path = output_directory + L"AboutFoxit.xml";
    bool ret = addon::conversion::Convert::ToXML(src_pdf_path, NULL, saved_xml_path,
                                      NULL, true);
