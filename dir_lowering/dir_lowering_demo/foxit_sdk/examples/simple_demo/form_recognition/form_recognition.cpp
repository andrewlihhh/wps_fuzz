...
{
  WString output_directory = output_path + L"form_recognition/";
  WString input_file = input_path + L"ElectricTable.pdf";
#if defined(_WIN32) || defined(_WIN64)
  ...
  try {
    ...
    WString newPdf = output_directory + L"ElectricTable_StartRecognizeForm.pdf";
